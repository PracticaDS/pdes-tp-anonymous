  ...
  return (
    <div className="dropdown">
      ...
      <div className="dropdown-menu" aria-labelledby="dropdownMenuLink">
        ...
        <a className="dropdown-item" href="#3" onClick={() => props.setCurrentAction('STARTER', material('ALUMINUM'))}>Aluminum</a>
        <a className="dropdown-item" href="#4" onClick={() => props.setCurrentAction('STARTER', material('COAL'))}>Coal</a>
        <a className="dropdown-item" href="#5" onClick={() => props.setCurrentAction('STARTER', material('IRON'))}>Iron</a>
        <a className="dropdown-item" href="#6" onClick={() => props.setCurrentAction('STARTER', material('TIN'))}>Tin</a>
      </div>
    </div>
  );
};
